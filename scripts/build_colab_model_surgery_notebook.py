...
def build_notebook() -> dict:
    cells = [
        ...
        code(
            ...
            "DRIVE_TRIPLETS_DIR = Path('/content/drive/MyDrive/unet_seam/outputs/synthetic_triplets_500')\n"
            "DRIVE_TRAIN_RUNS_DIR = Path('/content/drive/MyDrive/unet_seam/outputs/unet_seam_runs')\n"
            "DRIVE_LOCAL_CHECKPOINTS_DIR = Path('/content/drive/MyDrive/unet_seam/outputs/checkpoints')\n"
            "DRIVE_SURGERY_ROOT = Path('/content/drive/MyDrive/unet_seam/model_surgery_runs')\n"
        ...
        code(
            "# 5. COPY DATASETS / CHECKPOINTS / PREVIOUS OUTPUTS LOCALLY\n"
            ...
            "if COPY_RUNS_LOCALLY and DRIVE_TRAIN_RUNS_DIR.exists():\n"
            "    copy_tree(DRIVE_TRAIN_RUNS_DIR, LOCAL_RUNS_DIR, workers=8, wipe=True)\n"
            "if COPY_CHECKPOINTS_LOCALLY and DRIVE_LOCAL_CHECKPOINTS_DIR.exists():\n"
